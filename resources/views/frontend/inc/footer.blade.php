...
<!-- Google Analytics -->
<script async src="https://www.googletagmanager.com/gtag/js?id={{ env('GOOGLE_ANALYTIC_KEY') }}"></script>
<script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', '{{ env('GOOGLE_ANALYTIC_KEY') }}');
</script>
    ...
    <div class="container">
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-9 d-none d-lg-block">
                <div class="row">     
                    <!-- Contacts -->
                    {{-- <div class="col-md-4" style="margin-left: 4vw;"> --}}
                    ...
                    <div class="col-md-2">
                        <div class="text-center text-sm-left">
                            <h4 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('Support') }}</h4>
                            <ul class="list-unstyled">
                                    <li class="mb-2">
                                        <a class="fs-13 text-soft-light animate-underline-white" style="text-transform: capitalize;" href="{{ route('terms') }}">
                                        {{ translate('Terms & Conditions') }}
                                        </a>
                                    </li>
                                    <li class="mb-2">
                                        <a class="fs-13 text-soft-light animate-underline-white" style="text-transform: capitalize;" href="{{ route('returnpolicy') }}">
                                    ...
                                    <li class="mb-2">
                                        <a class="fs-13 text-soft-light animate-underline-white" style="text-transform: capitalize;" href="{{ route('supportpolicy') }}">
                                        {{ translate('Support Policy') }}
                                        </a>
                                    </li>
                                    <li class="mb-2">
                                        <a class="fs-13 text-soft-light animate-underline-white" style="text-transform: capitalize;" href="{{ route('privacypolicy') }}">
                    ...
                    <!-- Follow & Apps -->
                    <div class="{{ $col_values }}" style="padding-top: 10vh;">
                        <!-- Social -->
                        <div class="col">
                            @if ( get_setting('show_social_links') )
                                {{-- <h5 class="fs-14 text-secondary text-uppercase fw-700 mb-3">{{ translate('Follow Us') }}</h5> --}}
                                <ul class="list-inline social colored mb-4 d-flex">
...
<section class="py-lg-3 text-light footer-widget" style="background-color: #212129 !important;">
    ...
    <div class="d-lg-none bg-transparent">
        ...
        <div class="aiz-accordion-wrap bg-black">
            <div class="aiz-accordion-heading container bg-black">
                <button class="aiz-accordion fs-14 text-white bg-transparent">{{ translate('Support') }}</button>
            </div>
            <div class="aiz-accordion-panel bg-transparent" style="background-color: #212129 !important;">
                <div class="container">
                    <ul class="list-unstyled mt-3">
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['terms'],' active')}}">
                            <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" style="text-transform: capitalize;" href="{{ route('terms') }}">
                                {{ translate('Terms & Conditions') }}
                            </a>
                        </li>
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['returnpolicy'],' active')}}">
                            <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" style="text-transform: capitalize;" href="{{ route('returnpolicy') }}">
                                {{ translate('Return Policy') }}
                            </a>
                        </li>
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['supportpolicy'],' active')}}">
                            <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" style="text-transform: capitalize;" href="{{ route('supportpolicy') }}">
                                {{ translate('Support Policy') }}
                            </a>
                        </li>
                        <li class="mb-2 pb-2 {{ areActiveRoutes(['privacypolicy'],' active')}}">
                            <a class="fs-13 text-soft-light text-sm-secondary animate-underline-white" style="text-transform: capitalize;" href="{{ route('privacypolicy') }}">
                                {{ translate('Privacy Policy')}}
                            </a>
                        </li>
                    </ul>
