...
// For Sync status
Route::get('/sync', [App\Http\Controllers\AdminController::class, 'sync'])->name('backend.sync');
// Route::post('/sync/status/{id}', [App\Http\Controllers\AdminController::class, 'syncStatus'])->name('sync.status');
Route::post('/sync/store', [App\Http\Controllers\AdminController::class, 'store'])->name('sync.store');
// Route for updating status
Route::post('/sync/status/{id}', [App\Http\Controllers\AdminController::class, 'syncStatus'])->name('sync.status');
// Route for checking the status (polling)
Route::get('/sync/status/check/{id}', [App\Http\Controllers\AdminController::class, 'checkStatus'])->name('sync.status.check');
...
Route::group(['middleware' => ['customer', 'verified', 'unbanned']], function () {
    ...
    Route::group(['prefix' => 'checkout'], function () {
        Route::controller(CheckoutController::class)->group(function () {
            ...
            Route::get('/', 'index')->name('checkout.shipping_info');
