<div class="text-left">
    ...
    @else
        ...
        @if ($detailedProduct->pdf != null)
            <a href="{!! $detailedProduct->pdf !!}" target="_blank" 
                ...
                style="display: flex; width: 280px; gap: 8px; align-items: center; 
                       padding: 0px 28px; background-color: #dc3545; color: white; 
                       border-radius: 5px; text-decoration: none; margin-top: 13px;">
                <span style="font-size: 40px;">&#128462;</span>
                <span style="font-size: 16px;">Product Catalogue</span>
            </a>
        @endIf
        ...
        <a href="https://wa.me/+919073052545?text={{ $wa_message }}" class="wptwa-button wptwa-account wptwa-clearfix" data-number="919073052545" data-ga-label="Dominion Hardware" target="_blank">
            <span class="lab la-whatsapp" style="font-size: xxx-large;">
                {{-- <svg class="WhatsApp" width="40px" height="40px" viewBox="0 0 92 92">
                    <use xlink:href="#wptwa-logo"></use>
                </svg> --}}
            </span>
            <span class="wptwa-text">
                <span class="wptwa-profile">Dominion Hardware &nbsp;/&nbsp; Yusuf Tasira</span>
