...
@section('content')
    ...
    <div id="category_products" class="container">

        @php
        $category_array = array(1,52,42,41,30,28,29); 
        @endphp
        @foreach($category_array AS $category_id)
        @php
            $category = Category::find($category_id);
            $category_products = get_products_by_category(10,$category_id);
        ...
        @endphp
                ...
                <section class="mb-2 mb-md-3 mt-2 mt-md-3">
                    <div class="container" style="max-width: 100%!important;">
                        ...
                        <div class="px-sm-3">
                            ...
                            @php
                                $sorted_products = $category_products->sortBy('name');
                            @endphp
            ...
            @if (count($category_products) > 0)
                <section class="mb-2 mb-md-3 mt-2 mt-md-3" id="section_{{ $category_id }}">
                    <div class="container" style="max-width: 100%!important;">
                        <!-- Top Section -->
                        <div class="d-flex mb-2 mb-md-3 align-items-baseline justify-content-between">
                            <!-- Title -->
                            ...
                            <!-- Links -->
                            <div class="d-flex">
                                <a type="button" class="arrow-prev slide-arrow link-disable text-secondary mr-2" onclick="clickToSlide('slick-prev','section_{{ $category_id }}')"><i class="las la-angle-left fs-20 fw-600"></i></a>
                                <a type="button" class="arrow-next slide-arrow text-secondary ml-2" onclick="clickToSlide('slick-next','section_{{ $category_id }}')"><i class="las la-angle-right fs-20 fw-600"></i></a>
                            </div>
                        </div>
                        <!-- Product Section -->
                        <div class="px-sm-3">
