                    ...
                    <div class="col-xl-9">
                        ...
                        <div class="px-3">
                            <div class="row gutters-16 row-cols-xxl-4 row-cols-xl-3 row-cols-lg-4 row-cols-md-3 row-cols-2 border-top border-left">
                                @php
                                    $product_ids = [699,700,701, 702, 703, 704, 705, 706, 707, 708, 709, 710, 711, 712, 713];
                            
                                    // Extract prioritized products
                                    $prioritizedProducts = $products->filter(function($product) use ($product_ids) {
                                        return in_array($product->id, $product_ids);
                                    });
                            
                                    // Extract non-prioritized products
                                    $otherProducts = $products->reject(function($product) use ($product_ids) {
                                        return in_array($product->id, $product_ids);
                                    });
                                @endphp
                            
                                    <!-- Loop for prioritized products -->
                                    ...
                                    <!-- Loop for non-prioritized products -->
